...
function App() {
  return (
    <div className='min-h-screen bg-black relative flex items-center justify-center p-4 overflow-hidden'> 
      ...
      <div className="absolute pointer-events-none top-0 -left-4 size-96 bg-green-900 opacity-20 blur-[100px]" />
      <div className="absolute pointer-events-none bottom-0 -right-4 size-96 bg-yellow-900 opacity-20 blur-[100px]" />
